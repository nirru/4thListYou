...
import com.adapter.ReportUserAdapter;
 ...
 */
public class ReportUser extends Fragment {
    ...
    public ReportUserAdapter adapter;
    ...
    public ReportUser(Context mContext, User user, TextView mAddListCount) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragement_report_user, container,
                false);
        init(rootView);
        createAnim();
        setCustomFont();
...
//                        Toast.makeText(mContext, "No Friend Found please add first", Toast.LENGTH_LONG).show();
    ...
    private void setListviewToAdapter() {
        if (groupItem != null) {
            adapter = new ReportUserAdapter(mContext, user, groupItem, text1, text2, mTextSwitcher);
