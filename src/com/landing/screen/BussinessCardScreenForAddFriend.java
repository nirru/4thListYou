...
public class BussinessCardScreenForAddFriend extends Activity {
    ...
    private void init() {
        ...
        BussinessCardScreenForAddFriend.this.imageLoader.init(ImageLoaderConfiguration
        ...
        progressDialog = new ProgressDialog(BussinessCardScreenForAddFriend.this);
...
//			Log.e("FINAL RESPONSE  ", "" + response);
        ...
        public void onFailure(int i, Header[] headers, byte[] bytes, Throwable error) {
            if (error.getMessage() != null) {
                Util.showOKAleart(BussinessCardScreenForAddFriend.this, BussinessCardScreenForAddFriend.this.getString(R.string.error_title),
                        error.getMessage());
            } else {
                Util.showOKAleart(BussinessCardScreenForAddFriend.this, BussinessCardScreenForAddFriend.this.getString(R.string.error_title), BussinessCardScreenForAddFriend.this.getString(R.string.registration_response_error));
            }
        }
    ...
    private void selectImage(final int imageid) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(
                BussinessCardScreenForAddFriend.this);
...
//				Log.e("IMAGE NUMBER", "" + i);
    ...
    private void getImageFromgallery(Uri selectedImage, int number) {
        ...
        bitmapBussinessLogo = BussinessCardScreenForAddFriend
