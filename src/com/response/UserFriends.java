...
public class UserFriends implements Parcelable {
    ...
    public String id ,firstName, lastName, firstNameInOtherLang, lastNameInOtherlang, designation, comapnyName , userEmailAddress, companyEmailAddress, website, address, city, country, mobile, telephone, fax, countryCode, messanger, userPicUrl, companyPicUrl, bussinessPicUrl, qrcodeUrl, listyouid;

    /**
     * A constructor that initializes the User object
     */

    public UserFriends(String id, String firstName, String lastName, String firstNameInOtherLang, String lastNameInOtherlang, String designation, String comapnyName, String userEmailAddress, String companyEmailAddress, String website, String address, String city, String country, String mobile, String telephone, String fax, String countryCode, String messanger, String userPicUrl, String companyPicUrl, String bussinessPicUrl, String qrcodeUrl, String listyouid) {
    ...
    public static final Creator<UserFriends> CREATOR = new Creator<UserFriends>() {

        @Override
        public UserFriends createFromParcel(Parcel source) {
            return new UserFriends(source);
        }

        @Override
        public UserFriends[] newArray(int size) {
            return new UserFriends[size];
        }
    };
}
