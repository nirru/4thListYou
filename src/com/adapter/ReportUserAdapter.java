...
import com.util.ReportUserPermanentDialog;
...
public class ReportUserAdapter extends BaseAdapter {
    ...
    public ReportUserAdapter(Context context, User user, GroupItem groupitem, TextView left, TextView right, TextSwitcher mTextSwitcher) {
    ...
    View.OnClickListener l = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ChildItem childItem = getItem(v.getId());
            ReportUserPermanentDialog reportUserPermanentDialog = ReportUserPermanentDialog.getInstance();
            reportUserPermanentDialog.createDialog(context,user,childItem);
        }
    };
