...
public class SearchableListAdapter extends BaseAdapter {
    ...
    public SearchableListAdapter(Context context, User user, GroupItem groupitem, TextView left, TextView right, TextSwitcher mTextSwitcher) {
...
//        Log.e("Item Checked", "" + groupitem.items.size());
